...
@section('content')
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-between mb-3">
            <h1 class="fw-bold display-6 text-primary">All Product</h1>
            ...
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <p class="h3 card-title text-dark mb-3">Products</p>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('product.index', ['sort_by' => 'name', 'sort_order' => 'asc']) }}">Product
                                                Name Ascending</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('product.index', ['sort_by' => 'name', 'sort_order' => 'desc']) }}">Product
                                                Name Descending</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <table class="table table-bordered border-dark table-sm table-striped table-hover mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-dark">Product Category</th>
                                    <th class="text-dark" style="width: 100px">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($products as $product)
                                    ...
                                    <td class="text-dark">{{ 'Rp. ' . number_format($product->price, 0, ',', '.') }}
                                    </td>
                                    <td class="text-dark">{{ $product->categories->name }}</td>
                                    <td>
                                        <div class="d-flex justify-content-center align-items-center gap-3">
                                            <a href="{{ route('product.edit', $product->uuid) }}"
                                                class="btn btn-sm rounded btn-warning px-2 py-1">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <a href="{{ route('product.destroy', $product->uuid) }}"
