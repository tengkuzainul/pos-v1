...
@section('content')
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-between mb-3">
            <h1 class="fw-bold display-6 text-primary">Permission</h1>
            ...
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <p class="h3 card-title text-dark mb-3">Permissions</p>
                    </div>

                    <div class="row">
                        <div class="col-md-9 my-2">
                            <div class="d-flex gap-2 align-items-center">
                                <a href="{{ route('permission.print') }}" target="_blank"
                                    class="btn btn-sm btn-primary px-3 my-2"><i class="ti ti-printer me-2"></i>Print</a>

                                <a href="{{ route('permission.pdf') }}" target="_blank"
                                    class="btn btn-sm btn-primary px-3 my-2"><i class="ti ti-file-text me-2"></i>PDF</a>

                                <a href="{{ route('permission.excel') }}" class="btn btn-sm btn-primary px-3 my-2"><i
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('permission.index', ['sort_by' => 'name', 'sort_order' => 'asc']) }}">Permission
                                                Name Ascending</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('permission.index', ['sort_by' => 'name', 'sort_order' => 'desc']) }}">Permission
                                                Name Descending</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center align-items-center gap-3">
                                                <a href="{{ route('permission.destroy', $permission->uuid) }}"
                        ...
                        {{ $permissions->links('pagination::bootstrap-5', ['class' => 'pagination-sm px-2']) }}
                    </div>
                </div>
            </div>
        </div>
